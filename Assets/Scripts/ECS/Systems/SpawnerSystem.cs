...
namespace Borgs
{
    ...
    //[BurstCompile]
    //public partial struct BorgSchoolSpawnSystem : ISystem
    //{
    ...
    //                 SystemAPI.Query<RefRO<BorgSchool>, RefRO<LocalToWorld>>()
    //                     .WithEntityAccess())
    //        {
    //            var boidEntities =
    ...
    //            var setBorgLocalToWorldJob = new SetBorgLocalToWorld
    //            {
    ...
    //            };
    //            state.Dependency = setBorgLocalToWorldJob.Schedule(boidSchool.ValueRO.Count, 64, state.Dependency);
    ...
    //[BurstCompile]
    //struct SetBorgLocalToWorld : IJobParallelFor
    //{
